"""
Default HTML template for the Art Gallery Generator
"""
            ...
            <div class="modal-body">
                ...
                <div class="media-viewer" id="mediaViewer">
                    <div class="zoom-controls" id="zoomControls">
                        <button class="zoom-btn" id="fitBtn" onclick="toggleFitWindow()" title="Fit to window">⛶</button>
                        <button class="zoom-btn" id="zoomOutBtn" onclick="zoomImage(-0.5)" title="Zoom out">−</button>
                        <button class="zoom-btn" id="zoomInBtn" onclick="zoomImage(0.5)" title="Zoom in">+</button>
                        <button class="zoom-btn" id="resetBtn" onclick="resetZoom()" title="Reset zoom">⌂</button>
                    </div>
                    <div class="media-hover-zone left" onclick="navigateMedia(-1)">
                        <button class="media-nav-arrow prev">‹</button>
                    </div>
                    <div class="media-hover-zone right" onclick="navigateMedia(1)">
                        <button class="media-nav-arrow next">›</button>
                    </div>
                </div>
